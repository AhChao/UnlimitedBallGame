...
//[x1,x2,y1,y2,屬性,x位移,y位移,位移時間,空著,只跑一次,定點傳送x,定點傳送y]//碰到障礙物不要觸發重力
var stageSet =
{
  "BasicStage" :
  {
  ...
  "0104NewYear":
  {
    "obstacleSet" : //[x1,x2,y1,y2,特殊(option)]//碰到障礙物不要觸發重力
    {
      ...
      //"rightfloor":[480,500,-9999,500,"noClimb"],
      //"downfloor":[20,480,480,500,"noClimb"],
      "upfloor":[20,490,0,20,"noClimb"],

      "start":[20,80,60,80,"noClimb"],
      "two0":[40,240,110,130,"noClimb"],
      "two1":[40,200,160,180,"noClimb"],
      "two2":[240,260,110,180,"noClimb"],
      "two3":[40,60,110,180,"noClimb"],
      "two4":[240,260,180,230,"ice"],
      "two5":[240,260,230,300,"dead"],
      "two6":[180,200,180,250,"dead"],
      "two7":[210,260,300,320,"dead"],
      "two8":[90,210,300,320,"cantPass"],
      "two9":[90,180,230,250,"dead"],
      "two10":[40,60,230,320,"cantPass"],
      "two11":[60,90,230,250,"ice"],
      "two12":[40,60,320,460,"noClimb"],
      "two13":[90,110,320,380,"noClimb"],
      "two14":[90,260,440,460,"dead"],
      "two15":[140,160,380,400,"dead"],
      "two16":[190,210,380,400,"dead"],
      "two17":[260,280,400,460,"dead"],
      
      "twoToNext":[70,100,420,440,"spring",150,0,5],

      "zero1":[380,420,60,80,"noClimb"],
      "zero2":[290,310,20,250,"noClimb"],
      //"zero3":[310,350,60,80,"ice"],
      "zero4":[250,310,250,270,"dead"],
      "zero5":[290,310,270,350,"noClimb"],
      "zero6_bot":[290,490,330,350,"noClimb"],
      "zero7":[380,390,80,260,"noClimb"],
      "zero8":[410,420,80,260,"noClimb"],
      "zero9":[380,420,240,260,"noClimb"],
      "zero10_block":[395,400,20,60,"noClimb"],

      "zero11":[310,330,60,80,"noClimb",0,200,6],
      "zero12":[335,355,60,80,"noClimb",0,200,4],
      "zero13":[360,380,60,80,"noClimb",0,200,2],
      "zero14":[315,325,260,280,"dead",0,-200,2],
      "zero15":[340,350,260,280,"dead",0,-200,4],
      "zero16":[365,375,260,280,"dead",0,-200,6],

      "zero17":[420,440,60,80,"noClimb",0,200,6],
      "zero18":[445,465,60,80,"noClimb",0,200,4],
      "zero19":[470,490,60,80,"noClimb",0,200,2],
      "zero20":[425,435,60,80,"dead",0,250,3],
      "zero21":[450,460,60,80,"dead",0,250,5],
      "zero22":[475,485,60,80,"dead",0,250,7],
      "zero23":[490,510,0,350,"noClimb"],
      "zero24_block":[400,415,20,60,"tele",0,0,1,0,0,50,40],

      "one1_top":[620,750,40,60,"noClimb"],
      "one1.5":[600,620,60,80,"noClimb"],
      "one2":[580,600,80,100,"noClimb"],
      "one3":[560,580,100,120,"noClimb"],
      "one4":[540,560,120,200,"noClimb"],
      "one5":[560,620,180,200,"noClimb"],
      "one6":[620,640,140,200,"noClimb"],
      "one7":[640,660,120,140,"noClimb"],
      "one8":[660,680,100,360,"noClimb"],
      "one9":[750,770,40,360,"noClimb"],
      "one10":[540,680,360,380,"noClimb"],
      "one11":[540,560,380,440,"noClimb"],
      "one12_bottom":[540,860,440,460,"noClimb"],
      "one13":[840,860,380,440,"noClimb"],
      "one14":[750,860,360,380,"noClimb"],

      

      "lock":[60,80,130,150,"lock"],
      "lock2":[150,170,200,220,"lock"],
      "twoEnd":[320,340,440,460,"tele"],

      "lockProtec":[0,10,0,10,"lock"],
    ...
    "chasing":true,
    "telePoint" : [380,40],
    "respawnPoint" : [600,140],
    "stageName" : "0104NewYear",
